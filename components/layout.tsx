...
import { FileText, LogOut, MessageSquare, Menu, User, Gavel } from "lucide-react" // Added Gavel icon
  ...
  const NavigationContent = () => (
    <>
      ...
      <nav className="flex-1 px-3 lg:px-4 space-y-2">
        ...
        <Link href="/legal-documents" onClick={() => setIsSidebarOpen(false)}>
          <Button
            variant={pathname === "/legal-documents" ? "default" : "ghost"}
            className={`w-full justify-start text-sm lg:text-base ${
          ...
          >
            <Gavel className="mr-2 lg:mr-3 h-4 w-4" />
            Legal Documents
          </Button>
        </Link>
